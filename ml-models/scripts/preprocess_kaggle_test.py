"""
Preprocess Kaggle Test images for the redesigned handwriting module.

Run from project root:
    python ml-models/scripts/preprocess_kaggle_test.py
"""
...
def main() -> int:
    ...
    input_root = project_root / "data" / "raw" / "handwriting" / "kaggle_dyslexia" / "Test"
    output_root = (
        project_root / "data" / "processed" / "handwriting" / "kaggle_preprocessed" / "Test"
    )

    print("=" * 72)
    print("STEP 1.5 - PREPROCESS KAGGLE TEST IMAGES")
    print("=" * 72)
    ...
    print("\nFinal preprocessed Test counts:")
    for class_name in CLASSES:
        print(f"  {class_name}: {class_counts[class_name]:,}")
    print(f"  TOTAL: {total_processed:,}")

    print(f"\nStep 1.5 COMPLETE — {total_processed:,} Test images preprocessed")
    return 0
